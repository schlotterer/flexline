...
(function () {
   ...
   */
  var normalizeTemplateSlug = function normalizeTemplateSlug(value) {
    if (!value) {
      return '';
    }
    var tpl = String(value);
    ...
    tpl = tpl.replace(/\.[^.]+$/, '');
    // Sanitize to slug
    return tpl.trim().toLowerCase().replace(/[^a-z0-9-]+/g, '-').replace(/^-+|-+$/g, '');
  };
  ...
  subscribe(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    ...
    var editedTemplate, normalized, starterSlug, starter, markup, blocksInEd, action, newBlocks, idsToRemove;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 2:
          ...
          busy = true;
          normalized = normalizeTemplateSlug(editedTemplate);
          if (normalized) {
            _context2.n = 3;
            break;
          }
          ...
          return _context2.a(2);
        case 3:
          starterSlug = "".concat(normalized, "-starter");
          _context2.n = 4;
