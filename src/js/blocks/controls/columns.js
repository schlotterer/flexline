        ...
        <InspectorControls>
            <PanelBody title="FlexLine Scroller Options">
                <ToggleControl
                    ...
                    onChange={(newValue) =>
                        props.setAttributes({ enableHorizontalScroller: newValue })
                    }
                />
                ...
                {props.attributes.enableHorizontalScroller && (
                    <RangeControl
                        ...
                        onChange={(newInterval) =>
                            props.setAttributes({ transitionDuration: newInterval })
                        }
                        defaultValue={500}
                        min={100}
                        max={1500}
                ...
                {props.attributes.enableHorizontalScroller && props.name !== 'core/post-template' && (
                    <ToggleControl
                ...
                {props.attributes.enableHorizontalScroller && (
                    <SelectControl
                        ...
                        onChange={(value) =>
                            props.setAttributes({ positionButtonsHorizontal: value })
                        }
                    />
                )}
                {props.attributes.enableHorizontalScroller && (
                    <SelectControl
                        ...
                        onChange={(value) =>
                            props.setAttributes({ positionButtonsVertical: value })
                        }
                    />
                )}
                {props.attributes.enableHorizontalScroller && (
                    <ToggleControl
                        ...
                        onChange={(newValue) =>
                            props.setAttributes({ positionButtonsOver: newValue })
                        }
                    />
                )}
                {props.attributes.enableHorizontalScroller && (
                ...
                {props.attributes.enableHorizontalScroller && (
                    <SelectControl
                        ...
                        onChange={(value) =>
                            props.setAttributes({ buttonsBackgroundColor: value })
                        }
                    />
                )}
                {props.attributes.enableHorizontalScroller && (
                ...
                {props.attributes.enableHorizontalScroller && props.attributes.scrollAuto && (
                    <ToggleControl
                        label="Hide Pause Button"
                        checked={!!props.attributes.hidePauseButton}
                        onChange={(newValue) =>
                            props.setAttributes({ hidePauseButton: newValue })
                        }
                    />
                )}
                {props.attributes.enableHorizontalScroller && props.attributes.scrollAuto && (
                ...
                {props.attributes.enableHorizontalScroller && props.attributes.scrollAuto && (
                    <RangeControl
                        ...
                        onChange={(newInterval) =>
                            props.setAttributes({ scrollSpeed: newInterval })
                        }
                        defaultValue={4000}
                        min={1000}
                        max={10000}
...
export const useHooks = (props) => {
    const { attributes: { enableHorizontalScroller, isStackedOnMobile }, setAttributes, name } = props;
    useEffect(() => {
        ...
        if (name === 'core/columns') {
            const toggleWarning = () => {
                document
                    ...
                    .forEach((notice) => {
                        const textDiv = notice.querySelector('.components-notice__content');
