 ...
 * Slug: flexline/footer-default-dark
 * Categories: footer
...
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'flexline' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'flexline' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Facebook', 'flexline' ); ?></a> · <a href="#"><?php echo esc_html__( 'Twitter', 'flexline' ); ?></a> · <a href="#"><?php echo esc_html__( 'Instagram', 'flexline' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
