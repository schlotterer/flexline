...
<div class="wp-block-group alignfull headroom-hide-on-scroll has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0;padding-top:8px;padding-right:30px;padding-bottom:8px;padding-left:30px"><!-- wp:group {"metadata":{"name":"Content Row"},"className":"","style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"}} -->
    <div class="wp-block-group"><!-- wp:paragraph {"align":"center","className":"","style":{"typography":{"lineHeight":"1.5"}},"fontSize":"x-small"} -->
        ...
        <div class="wp-block-buttons"><!-- wp:button {"className":"flexline-icon-none","style":{"typography":{"fontSize":"14px"},"spacing":{"padding":{"top":"5px","bottom":"5px","left":"15px","right":"15px"}}}} -->
            <div class="wp-block-button flexline-icon-none"><a class="wp-block-button__link has-custom-font-size wp-element-button" href="/wp-admin/site-editor.php?postType=wp_template_part&amp;postId=flexline%2F%2Fnotification-bar&amp;canvas=edit" style="padding-top:5px;padding-right:15px;padding-bottom:5px;padding-left:15px;font-size:14px" target="_blank" rel="noreferrer noopener">Change it here</a></div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
    </div>
