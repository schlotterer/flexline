...
<h3 class="wp-block-heading has-x-large-font-size" id="sample-heading-1"><?php echo esc_html__( 'Build with FlexLine', 'flexline' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Learn More', 'flexline' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
