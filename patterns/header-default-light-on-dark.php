...
<div class="wp-block-group has-dark-transparent-top-to-bottom-gradient-background has-background" style="padding-top:0;padding-right:var(--wp--preset--spacing--large);padding-bottom:0;padding-left:var(--wp--preset--spacing--large)">
    ...
    <!-- wp:group {"metadata":{"name":"Header Container"},"align":"wide","className":"","style":{"spacing":{"padding":{"top":"8px","bottom":"8px","left":"var:preset|spacing|small","right":"var:preset|spacing|small"},"margin":{"top":"0px"},"blockGap":"var:preset|spacing|small"},"dimensions":{"minHeight":"70px"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
    <div class="wp-block-group alignwide" id="header_container" style="min-height:70px;margin-top:0px;padding-top:8px;padding-right:var(--wp--preset--spacing--small);padding-bottom:8px;padding-left:var(--wp--preset--spacing--small)"><!-- wp:group {"metadata":{"name":"Logo Group"},"className":"","style":{"spacing":{"margin":{"top":"5px","bottom":"5px"}}},"layout":{"type":"constrained","contentSize":"200px"}} -->
        <div class="wp-block-group" style="margin-top:5px;margin-bottom:5px"><!-- wp:site-logo {"width":225,"className":"","style":{"color":{"duotone":["#ffffff","#ffffff"]}}} /--></div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group"><!-- wp:group {"metadata":{"name":"Navigations Stack"},"className":"","style":{"spacing":{"blockGap":"var:preset|spacing|x-small"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"right","verticalAlignment":"center"}} -->
            <div class="wp-block-group"><!-- wp:group {"metadata":{"name":"Anchor Nav"},"className":"headroom-hide-on-scroll flexline-hide-on-mobile flexline-hide-on-tablet","style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"},"hideOnTablet":true,"hideOnMobile":true} -->
                <div class="wp-block-group headroom-hide-on-scroll flexline-hide-on-mobile flexline-hide-on-tablet"><!-- wp:navigation {"showSubmenuIcon":false,"overlayMenu":"never","overlayBackgroundColor":"secondary","overlayTextColor":"base","className":"is-style-light-over-dark","style":{"spacing":{"blockGap":"var:preset|spacing|small"},"typography":{"textTransform":"uppercase","lineHeight":"1.05"}},"fontSize":"x-small","layout":{"type":"flex","justifyContent":"center"}} /--></div>
                <!-- /wp:group -->
                ...
                <div class="wp-block-group flexline-hide-on-mobile flexline-hide-on-tablet"><!-- wp:navigation {"showSubmenuIcon":false,"overlayMenu":"never","icon":"menu","overlayBackgroundColor":"secondary","className":"is-style-light-over-dark","style":{"spacing":{"blockGap":"var:preset|spacing|x-small"},"typography":{"textTransform":"none","lineHeight":"1.05"}},"fontSize":"small","layout":{"type":"flex","justifyContent":"center","flexWrap":"wrap"}} /--></div>
                <!-- /wp:group -->
            </div>
            <!-- /wp:group -->
            ...
            <div class="wp-block-buttons flexline-hide-on-mobile"><!-- wp:button {"className":"flexline-icon-none","style":{"spacing":{"padding":{"left":"var:preset|spacing|large","right":"var:preset|spacing|large","top":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium"}},"typography":{"textTransform":"uppercase"}}} -->
                <div class="wp-block-button flexline-icon-none"><a class="wp-block-button__link wp-element-button" href="/contact/" style="padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--large);text-transform:uppercase">Contact</a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
        </div>
