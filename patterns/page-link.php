...
<figure class="wp-block-image aligncenter size-full is-resized is-style-rounded"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/fallback.webp'; ?>" alt="<?php echo esc_attr__( 'Sample Image', 'flexline' ); ?>" class="wp-image-3489" width="120" height="120"/></figure>
<!-- /wp:image -->
