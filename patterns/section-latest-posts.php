 ...
 */
?>
<!-- wp:group {"align":"full","className":"latests-posts-3-card","layout":{"type":"constrained"},"metadata":{"name":"Latests Posts - 3 card"}} -->
<div class="wp-block-group alignfull latests-posts-3-card"><!-- wp:heading {"textAlign":"center"} -->
