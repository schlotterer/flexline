...
<div class="wp-block-group is-style-outlined"><!-- wp:image {"id":765,"aspectRatio":"3/2","scale":"cover","sizeSlug":"large","linkDestination":"none","metadata":{"name":"Image with Modal Link"},"style":{"color":{},"border":{}},"className":"is-style-default","enableModal":true,"modalMediaURL":"https://designfloorplan.com/plan/?PlanID=3624"} -->
    <figure class="wp-block-image size-large has-custom-border is-style-default"><img src="<?php echo esc_url(feature_image_fallback()); ?>" alt="" class="wp-image-765" style="aspect-ratio:3/2;object-fit:cover" /></figure>
    <!-- /wp:image -->
