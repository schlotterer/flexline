<?php
/**
 * Title: Box Card style with heading, text, button.
 * Slug: flexline/box-card
 * Categories: flexline-components
 */
?>
<!-- wp:group {"className":"is-style-card-padded","layout":{"type":"constrained"},"metadata":{"name":"Box - text and button"}} -->
