 ...
 */
?>
<!-- wp:columns {"lock":{"move":true,"remove":true},"metadata":{"name":"CTA Content Columns"},"className":"","style":{"spacing":{"blockGap":{"left":"0"},"padding":{"top":"var:preset|spacing|x-small","bottom":"var:preset|spacing|x-small"},"margin":{"top":"0","bottom":"0"}}}} -->
<div class="wp-block-columns" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--x-small);padding-bottom:var(--wp--preset--spacing--x-small)"><!-- wp:column {"verticalAlignment":"center","width":"","templateLock":"all","lock":{"move":true,"remove":true},"metadata":{"name":"Title and Text Column"},"className":""} -->
