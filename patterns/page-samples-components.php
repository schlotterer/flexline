...
<!-- wp:pattern {"slug":"fflexline/subnav-sticky"} /-->
...
<div class="wp-block-group alignfull" style="padding-right:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)"><!-- wp:heading -->
    ...
    <!-- wp:pattern {"slug":"flexline/product-card"} /-->

    <!-- wp:pattern {"slug":"flexline/product-box"} /-->

    <!-- wp:pattern {"slug":"flexline/product-card-dark"} /-->
