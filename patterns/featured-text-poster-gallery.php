...
<h2 class="wp-block-heading has-text-align-left has-max-48-font-size" style="margin-bottom:0px;letter-spacing:-1px">Experience the next generation of WordPress.</h2>
<!-- /wp:heading -->
...
<figure class="wp-block-gallery has-nested-images columns-default is-cropped"><!-- wp:image {"id":185,"sizeSlug":"large","linkDestination":"media"} -->
<figure class="wp-block-image size-large"><a href="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/featured-2.jpg'; ?>" alt="" class="wp-image-185"/></a></figure>
<!-- /wp:image -->

<!-- wp:image {"id":185,"sizeSlug":"large","linkDestination":"media"} -->
<figure class="wp-block-image size-large"><a href="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/featured-2.jpg'; ?>" alt="" class="wp-image-185"/></a></figure>
<!-- /wp:image -->
