...
<figure class="wp-block-image size-large"><a href="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/feature-3.pg'; ?>"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/feature-3.pg'; ?>" alt=""/></a><figcaption class="wp-element-caption">Image Caption</figcaption></figure>
<!-- /wp:image -->

<!-- wp:image {"sizeSlug":"large","linkDestination":"media"} -->
<figure class="wp-block-image size-large"><a href="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/feature-3.pg'; ?>"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/feature-3.pg'; ?>" alt=""/></a></figure>
<!-- /wp:image -->
