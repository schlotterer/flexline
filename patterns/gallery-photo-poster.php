...
<div class="wp-block-column is-vertically-aligned-stretch"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"},"metadata":{"name":"Poster Gallery Group"}} -->
<div class="wp-block-group"><!-- wp:gallery {"columns":3,"linkTo":"media","enablePosterGallery":true} -->
<figure class="wp-block-gallery has-nested-images columns-3 is-cropped"><!-- wp:image {"id":372,"sizeSlug":"large","linkDestination":"media","className":"is-style-shadow-light"} -->
<figure class="wp-block-image size-large is-style-shadow-light"><a href="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/featured-9.jpg'; ?>"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/featured-9.jpg'; ?>" alt="" class=""/></a><figcaption class="wp-element-caption">Image Caption</figcaption></figure>
<!-- /wp:image -->
