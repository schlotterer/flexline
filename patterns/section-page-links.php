...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0">
    ...
    <!-- wp:cover {"url":"<?php echo esc_url(feature_image_fallback()); ?>","id":518,"dimRatio":90,"overlayColor":"neutral","align":"full","style":{"color":{"duotone":["#000000","#ffffff"]}},"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
    <div class="wp-block-cover alignfull" style="margin-top:0;margin-bottom:0"><span aria-hidden="true" class="wp-block-cover__background has-neutral-background-color has-background-dim-90 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-518" alt="" src="<?php echo esc_url(feature_image_fallback()); ?>" data-object-fit="cover" />
