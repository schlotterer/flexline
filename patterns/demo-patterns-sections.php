...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0"><!-- wp:group {"metadata":{"name":"Subnav Sticky"},"align":"full","className":"is-style-shadow-dark","style":{"elements":{"link":{"color":{"text":"var:preset|color|base"},":hover":{"color":{"text":"var:preset|color|secondary"}}}},"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"}},"position":{"type":"sticky","top":"0px"}},"textColor":"base","gradient":"primary-primaryDark","layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide is-style-outlined has-neutral-neutralLight-gradient-background has-background" style="padding-top:var(--wp--preset--spacing--large);padding-right:0;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:heading {"align":"wide","className":""} -->
    ...
    <div class="wp-block-query"><!-- wp:post-template {"className":"is-style-horizontal-scroll scroller-pause-on-hover horizontal-scroller-buttons-horizontal-left horizontal-scroller-buttons-vertical-bottom scroller-buttons-border-none horizontal-scroller-hide-scrollbar scroller-buttons-text-default scroller-buttons-background-default horizontal-scroller-auto horizontal-scroller-navigation","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"grid","columnCount":null,"minimumColumnWidth":"200px"},"enableHorizontalScroller":true,"scrollAuto":true,"hideScrollbar":true,"buttonsTextColor":"default","buttonsBackgroundColor":"default","buttonsBoxShadow":true} -->
        <!-- wp:group {"metadata":{"name":"Post Grid Single - Card Image, Category, Title"},"className":"is-style-card-alt","style":{"spacing":{"blockGap":"0","padding":{"right":"0","left":"0"}},"dimensions":{"minHeight":"100%"}},"backgroundColor":"base","layout":{"type":"flex","orientation":"vertical","verticalAlignment":"center","justifyContent":"stretch"}} -->
        <div class="wp-block-group is-style-card-alt has-base-background-color has-background" style="min-height:100%;padding-right:0;padding-left:0"><!-- wp:cover {"url":"https://staging2.flexlinetheme.com/wp-content/themes/flexline/assets/built/images/fallback.webp","id":527,"dimRatio":50,"minHeight":200,"minHeightUnit":"px","gradient":"primary-primaryDark","className":"","style":{"color":{"duotone":"var:preset|duotone|primary"},"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide"><!-- wp:group {"metadata":{"name":"Gallery Modal - Wide"},"className":"is-style-outlined","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
