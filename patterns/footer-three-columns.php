 ...
 * Slug: flexline/footer-three-columns
 * Categories: footer
...
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'flexline' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'flexline' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'flexline' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'flexline' ); ?></a></p>
<!-- /wp:paragraph -->
