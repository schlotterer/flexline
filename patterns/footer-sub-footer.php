...
<div class="wp-block-group alignfull has-background-color has-base-color has-contrast-background-color has-text-color has-background has-link-color has-small-font-size" style="margin-top:0px;padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)"><!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|medium"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"}} -->
    <div class="wp-block-group alignwide"><!-- wp:paragraph {"align":"center"} -->
        <p class="has-text-align-center">© [flexline_copyright_year] Your Company LLC </p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group"><!-- wp:image {"id":727,"width":"auto","height":"40px","sizeSlug":"full","linkDestination":"none"} -->
            <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url(get_theme_file_uri()) . '/assets/images/mand-eho.webp'; ?>" alt="" class="wp-image-727" style="width:auto;height:40px" /></figure>
            <!-- /wp:image -->

            <!-- wp:image {"id":726,"width":"auto","height":"40px","sizeSlug":"full","linkDestination":"none"} -->
            <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url(get_theme_file_uri()) . '/assets/images/mand-ada.png'; ?>" alt="" class="wp-image-726" style="width:auto;height:40px" /></figure>
            <!-- /wp:image -->

            <!-- wp:image {"id":728,"width":"auto","height":"40px","sizeSlug":"full","linkDestination":"none"} -->
            <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url(get_theme_file_uri()) . '/assets/images/mand-pet-friendly.webp'; ?>" alt="" class="wp-image-728" style="width:auto;height:40px" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:group -->
    </div>
