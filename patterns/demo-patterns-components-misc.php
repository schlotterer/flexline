...
<div class="wp-block-group alignfull has-neutral-background-color has-background" style="padding-top:var(--wp--preset--spacing--medium)"><!-- wp:heading {"level":3,"className":""} -->
    ...
    <figure class="wp-block-image aligncenter size-large is-style-dots enable-modal" style="margin-top:var(--wp--preset--spacing--small);margin-bottom:var(--wp--preset--spacing--small)"><img src="https://cdn.loom.com/sessions/thumbnails/91c4cd63790c4c489863c7c290de23de-8c73148fccc73156-full-play.gif" /></figure>
    <!-- /wp:image -->
