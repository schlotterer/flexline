...
<p class="has-text-align-center has-small-font-size">&copy; 2023 <?php echo esc_html__( 'Your Company LLC', 'flexline' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'flexline' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
