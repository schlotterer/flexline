...
/**
 * Title: Testimonial Wide with Picture - outline
 * Options : plain, outline, card, card-padded
 * Slug: flexline/testimonial-wide-outline
 * Categories: flexline-components, flexline-misc
 */
?>
<!-- wp:quote {"align":"right","className":"is-style-outlined","fontFamily":"display"} -->
<blockquote class="wp-block-quote has-text-align-right is-style-outlined has-display-font-family"><!-- wp:columns {"verticalAlignment":null} -->
